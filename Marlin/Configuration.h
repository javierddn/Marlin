...
#define STRING_CONFIG_H_AUTHOR "(@javierddn)" // Original author or contributor.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -20, -33.3, -2.5 }
 ...
 */
#define EVENT_GCODE_AFTER_G29 "G1 Z10 F180\nG1 X10 Y287"
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_STROKES     3   // Default number of pattern repetitions
