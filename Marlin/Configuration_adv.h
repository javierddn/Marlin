...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.11 }    // (mm) Compression length per 1mm/s extruder speed, per extruder. Override with 'M900 T<tool> K<mm>'.
  #else
    #define ADVANCE_K 0.11        // (mm) Compression length for all extruders. Override with 'M900 K<mm>'.
  #endif
